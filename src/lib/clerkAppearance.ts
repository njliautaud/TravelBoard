 ...
 * Typed as `any` because Clerk SDK type definitions don't cover all
 * runtime-accepted variables/elements across versions.
 */

// eslint-disable-next-line @typescript-eslint/no-explicit-any
export const clerkComponentAppearance: any = {
  variables: {
    colorPrimary: "#f59e0b",
